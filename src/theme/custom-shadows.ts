...
export function customShadows(mode: 'light' | 'dark') {
  ...
  // const transparent = alpha(color, 0.25);
  ...
  return {
    ...
    //
    // Updated card shadow
    // card: `0 2px 4px 0 ${alpha(color, 0.2)}, 0 14px 28px -4px ${transparent}`,
    // card: `rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px`, // Updated card shadow2
