'use client';
// import { mainInfo } from 'src/sections/wheat-sales/view/sales-data-view';
...
export default function SalesDataView() {
  ...
  // --- MODIFIED: Added state for the year to be displayed in the table ---
  ...
  const [currentTab, setCurrentTab] = useState('executiveSummary'); // Set 'mReports' as default
  ...
  function handleOnClick() {
    // --- MODIFIED: Update the displayYear state on submit ---
