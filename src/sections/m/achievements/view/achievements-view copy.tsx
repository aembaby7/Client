...
export default function MDashboardViewCopy() {
  const now = new Date();
      ...
      {mInfo && (
        <Grid container spacing={SPACING} disableEqualOverflow>
          ...
          <Grid xs={12} md={12}>
            ...
            >
              <Box sx={{ width: 1, textAlign: 'center', paddingBottom: '10px' }}>
              ...
              <Grid container spacing={SPACING} disableEqualOverflow>
                <Grid xs={12} md={3}>
                  <BookingWidgetSummary
                    title={'غير محدثة بياناتهم مباشرين | مستفيدين'}
                ...
                <Grid xs={12} md={3}>
                  <BookingWidgetSummary
                    title={'الكمية المخصصة شهرياً بالطن'}
                ...
                <Grid xs={12} md={3}>
                  <BookingWidgetSummary
                    title={'غير محدثة بياناتهم موزعين | متعددين'}
                ...
                <Grid xs={12} md={6}>
                  <BookingWidgetSummary
                    title={'1000 كيس شهرياً دون استمارة زيارة' + ' ' + 'مباشرين | مستفيدين'}
          ...
          <Grid xs={12} md={12} hidden>
            <Stack spacing={3}>
              <YearlySalesInQty
                title={'تغير المبيعات وفق الفترة'}
                chart={{
                  categories: customersQtyInQuarterNames,
                  series: [
                    {
                      type: 'Year',
                      data: [
                        {
                          name: 'المبيعات',
                          data: customersQtyInQuarterValues,
                        },
                        // {
                        //   name: 'الكميات الموقوفة',
          ...
          <Grid xs={12} md={12} hidden>
            <Stack spacing={3}>
              <BankingBalanceStatistics
                title={'الكميات المخصصة وفق الفترة'}
                defaultState="الكميات"
                chart={{
                  categories: getArray(mInfo.customersQtyInQuarter, 'quarterFDesc'),
                  series: [
                    {
                      type: 'عام',
                      data: [
                        {
                          ...
                          data: getArray(mInfo.customersQtyInQuarter, 'totalQtyInTons'),
                        },
                        {
                          name: 'عدد العملاء',
                          data: getArray(mInfo.customersQtyInQuarter, 'cntCustomers'),
                        },
                      ],
                    },
                    {
                ...
                <Grid xs={12}>
                  <BookingDetails
                    ...
                    tableLabels={[
                      ...
                      { id: 'totalQtyInTonsDiff', label: 'الفارق', align: 'center' },
