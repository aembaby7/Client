...
import AppsPie from 'src/sections/admin_dashboard/apps-pie';
import AppsPieN from 'src/sections/admin_dashboard/apps-pie-n';
import ChartColumnMultiple from 'src/sections/app/chart-column-multiple';
import SeasonWeightTotalChart from 'src/sections/admin_dashboard/season-weight-total';
import RejectDetails from 'src/sections/admin_dashboard/reject-details';
...
export default function MahsoliGIntakeDashboardView() {
  const now = new Date();
              ...
              <Grid container xs={12}>
                ...
                <Grid xs={12} md={6}>
                  <Card>
                    ...
                    {data?.result.branchesTodayWaitingApps &&
                    ...
                    >
                      <AppsPieN
                        series={[
                          ...
                          data?.result?.trucksRejectReasons?.length! > 3
                            ? data?.result.trucksRejectReasons[3].counter!
                            : 0,
                          data?.result?.trucksRejectReasons?.length! > 4
                            ? data?.result.trucksRejectReasons[4].counter!
                            : 0,
                          data?.result?.trucksRejectReasons?.length! > 5
                            ? data?.result.trucksRejectReasons[5].counter!
                            : 0,
                          data?.result?.trucksRejectReasons?.length! > 6
                            ? data?.result.trucksRejectReasons[6].counter!
                            : 0,
                          data?.result?.trucksRejectReasons?.length! > 7
                    ...
                    >
                      <AppsPieN
                        ...
                        labels={[
                          ...
                          data?.result?.branchesTrucksDockages?.length! > 3
                        ...
                        series={[
                          {
                            ...
                            data: [
                              ...
                              data?.result?.branchesTrucks?.length! > 4
                                ? data?.result.branchesTrucks[4].trucksAccepted!
                                : 0,
                              data?.result?.branchesTrucks?.length! > 5
                                ? data?.result.branchesTrucks[5].trucksAccepted!
                                : 0,
                              data?.result?.branchesTrucks?.length! > 6
                                ? data?.result.branchesTrucks[6].trucksAccepted!
                                : 0,
                              data?.result?.branchesTrucks?.length! > 7
                          ...
                          },
                          {
                            ...
                            data: [
                              data?.result?.branchesTrucks?.length! > 0
                                ? data?.result.branchesTrucks[0].trucksRejeced!
                                : 0,
                              data?.result?.branchesTrucks?.length! > 1
                                ? data?.result.branchesTrucks[1].trucksRejeced!
                                : 0,
                              data?.result?.branchesTrucks?.length! > 2
                                ? data?.result.branchesTrucks[2].trucksRejeced!
                                : 0,
                              data?.result?.branchesTrucks?.length! > 3
